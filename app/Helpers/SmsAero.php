...
class SmsAero {
    ...
    /**
     * Отправка запроса FlashCall
     */
    public function flashcall($phone, $code) {
      // https://email:api_key@gate.smsaero.ru/v2/flashcall/send?phone=79990000000&code=1234
      return json_decode(self::curl_post(self::URL_SMSAERO_API . '/flashcall/send', [
        'phone'      => $phone,
        'code'        => $code,
      ]), true);
    }
    ...
    /**
     * Проверка статуса FlashCall
     */
    public function flashcallStatus($id, $code) {
      return json_decode(self::curl_post(self::URL_SMSAERO_API . '/flashcall/status', [
        'id' => $id,
      ]), true);
    }
